...
if (isset($data->order_id)) {
	...
	if ($signature == $data->signature_key) {
		...
		$factory = (new Factory)->withServiceAccount('sitara-3b81f-firebase-adminsdk-gj3d9-f14b6d236b.json');
		$database = $factory->createDatabase();
		$postData = [
			'status' => $status,
			'id_transaksi' => $data->transaction_id,
			'waktu_transaksi' => $data->transaction_time,
